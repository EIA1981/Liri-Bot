...
var spotify = new Spotify({
  id: //client id path info//,
  secret: //client key path info//,
});

var defaultMovie = "Mrs. Doubtfire";
...
function getMovies(movieName) {
  ...
  axios.get("http://www.omdbapi.com/?i=tt3896198&apikey=83dea1de" + movieName)
    .then(function (data) {
    ...
    if (movieName === "Mrs. Doubtfire") {
      console.log("-----------------------");
      console.log("You should watch Mrs. Doubtfire: https://www.imdb.com/title/tt0107614/");
  };
}
